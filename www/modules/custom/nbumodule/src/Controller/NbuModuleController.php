...
/**
 * Простір імен нашого контролера.
 * Подібне на опис вище, але НЕ вказується назва нашого класу.
 */

namespace Drupal\nbumodule\Controller;

/**
 * Використовуємо клас з друпалу: ControllerBase. Наслідуємось від нього і він
 * зробить за нас всі обовязкові речі, які роблять контроллери.
 */
